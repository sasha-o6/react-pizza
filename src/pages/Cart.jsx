...
export default function Cart(props) {
    ...
    const items = cartSelector.items
        ...
        <div className="cart">
            <div className="cart__top">
                <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Корзина</h2>
                <button onClick={() => dispatch(clearItems())} type="button" className="cart__clear">
            ...
            <div className="cart__bottom">
                <div className="cart__bottom-details">
                    <span> Всего пицц: <b>{cartSelector.totalLength} шт.</b> </span>
                    <span> Сумма заказа: <b>{cartSelector.totalPrice} $</b> </span>
                </div>
